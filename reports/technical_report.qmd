...
Lukas Buchmann implemented the dashboard and the data processing pipeline, and took the lead in preparing the hand-in Git repository. Both Lukas and Etienne were involved in writing the technical report. Etienne focused on the geovisual analytics theory sections and the mapping of that theory onto the dashboard design decisions, while Lukas focused on describing the technical implementation. Both were involved in recording the explanatory video. Etienne performed the post-processing of the video and set up a containerised version of the dashboard for hosting on Hugging Face.
